...
public class AIP3FormationCar : MonoBehaviour
{
    ...
    private float pointFrequency = 10f;
    ...
    private void FixedUpdate()
    {
        ...
        PdControllSimple(targetPosition, 10f);
        
        // PdControll(targetPosition, targetVelocity);
        
    }

    private void PdControllSimple(Vector3 targetPosition, float velocity)
    {
        ...
        Vector3 tv = Vector3.Normalize(targetPosition - transform.position) * velocity;
        
        Vector3 posError = targetPosition - currentPos;
        ...
        float threshold = 3f;
        float distance = Vector3.Distance(targetPosition, currentPos);
